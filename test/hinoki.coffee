...
module.exports.parseFunctionArguments =
...
module.exports['find with 1 container'] =
...
module.exports['find with 3 containers'] =
...
module.exports['inject with 1 container'] =
...
module.exports['containers can depend on services in containers to the right of them'] = (test) ->
        container1 =
            factories:
                b: (a) ->
                    a + 1
...
module.exports['containers can not depend on services in containers to the left of them'] = (test) ->
        container1 =
            factories:
                a: -> 1
...
module.exports['inject with 3 containers'] =
    '3 async dependencies': (test) ->
        container1 =
            factories:
                c: (a, b) ->
...
module.exports['computation example'] =
