...
(function(root, factory) {
  ...
  hinoki.callFactory = function(lifetime, nameOrPath, factory, dependencyValues, debug) {
  ...
  hinoki.resolveInLifetime = function(lifetime, nameOrPath, debug) {
  ...
  hinoki.resolveInLifetimes = function(lifetimes, nameOrPath, debug) {
    var path;
    path = hinoki.coerceToArray(nameOrPath);
